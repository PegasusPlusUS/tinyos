ch01_bootsector/asm/bootsector.bin : ch01_bootsector/nasm/bootsector.asm
...
ch02_timer/asm/bootsector.bin : ch02_timer/nasm/bootsector.asm
	cd ch02_timer && make

build : ch02_timer/asm/bootsector.bin ch01_bootsector/.pipe/pb_holder/target/release/pb_holder	
