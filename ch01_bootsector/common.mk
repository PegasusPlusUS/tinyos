...
# Define FILE_SOURCE and FILE_TOC_SOURCE
FILE_SOURCE=$(BOOTSECTOR)$(LANG_SUFFIX)
FILE_SOURCE_DEPENDENCY=common_bios$(LANG_SUFFIX)
FILE_TOC_SOURCE=$(FILE_SOURCE).c
SCRIPT_COMPILER2C_POST_PROCESSING=echo "\# $(FILE_SOURCE) to $(FILE_TOC_SOURCE) succeeded!"
# Rule to build FILE_TOC_SOURCE
$(FILE_TOC_SOURCE): $(FILE_SOURCE) $(FILE_SOURCE_DEPENDENCY) $(FILE_SOURCE_ADDITIONAL_DEPENDENCY) $(FILE_THIS)
	@echo "# Compile $(FILE_TARGET) by $(COMPILER)."
	@$(COMPILER) $(COMPILER2C_FLAGS)$(FILE_TOC_SOURCE) $(FILE_SOURCE)
	@$(COMPILER2C_POST_PROCESSING)
